...
// SupportTrainer is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterTrainer.
contract SupportTrainer {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many DOGCAFE tokens the user has provided.
        uint256 rewardDebt;  // Reward debt. See explanation below.
        uint256 rewardPending;
        //
        // We do some fancy math here. Basically, any point in time, the amount of DOGCAFEs
        // entitled to a user but is pending to be distributed is:
        //
        //   pending reward = (user.amount * pool.accRewardPerShare) - user.rewardDebt + user.rewardPending
        //
        // Whenever a user deposits or withdraws DOGCAFE tokens to a pool. Here's what happens:
    ...
    // Deposit Syrup tokens to SupportTrainer for Reward allocation.
    ...
    // Withdraw Syrup tokens from SupportTrainer.
